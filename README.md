...
| `KEY_TEXT_KERNING`          | `VALUE_TEXT_KERNING_ON`<br>`VALUE_TEXT_KERNING_OFF`                                                             | `VALUE_TEXT_KERNING_ON`                                              | Whether kerning is applied during text layout (i.e. the behavior of `font-kerning: auto`)                                                                                    |
